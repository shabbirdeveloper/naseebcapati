...
function HomePage() {
  return <div className="home-page"><Hero /><QuickInfo /><HomepageStats /><FoodCoverflow /><CategoryGrid /><AboutBand /><BestSellers /><PromotionsSection /><HomeTeamSection /><ReviewSection /><GalleryStrip /><ReservationSection /><SocialSection /><BranchSection /></div>;
}
