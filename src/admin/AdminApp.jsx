...
function AdminLoginPreview({ onLogin }) {
  const [form, setForm] = useState({ email: 'admin@naseebchapati.com', password: '', role: 'super_admin' });
...
function AdminLogin({ onLogin, authMode }) {
  const [form, setForm] = useState({ email: 'admin@naseebchapati.com', password: '' });
  const [error, setError] = useState('');
