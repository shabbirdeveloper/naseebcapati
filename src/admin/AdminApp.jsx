...
function makeNewRecord(resource, rows = [], categories = []) {
  ...
  if (resource === 'menu') {
    ...
    return { id, slug: id, name: 'New menu item', category: firstCategory, order: nextOrder, price: 0, description: '', ingredients: '', image: '', badge: 'New', status: 'Draft', stock: 'Available', branchAvailability: [], halal: true };
  }
